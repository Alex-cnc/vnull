...
APP="${ROOT}/dist/PostgresClient.app"
...
echo "==> 编译 PostgresClientApp (${CONFIGURATION})"
"${SWIFT}" build \
  --product PostgresClientApp \
...
cp "${BIN}" "${APP}/Contents/MacOS/PostgresClient"
